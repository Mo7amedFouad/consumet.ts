...
class Proxy {
    ...
    setProxy(proxyConfig) {
        ...
        this.client.interceptors.request.use(config => {
            ...
            if (proxyConfig === null || proxyConfig === void 0 ? void 0 : proxyConfig.url) {
                if (config.headers) {
                    config.headers['x-api-key'] = (_a = proxyConfig === null || proxyConfig === void 0 ? void 0 : proxyConfig.key) !== null && _a !== void 0 ? _a : '';
                }
                config.url = `${proxyConfig.url}${(config === null || config === void 0 ? void 0 : config.url) ? config === null || config === void 0 ? void 0 : config.url : ''}`;
            }
            if (((_b = config === null || config === void 0 ? void 0 : config.url) === null || _b === void 0 ? void 0 : _b.includes('anify')) && config.headers)
